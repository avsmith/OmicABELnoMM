/* 
Code to add pthread_barrier to Mac
Based on http://blog.albertarmea.com/post/47089939939/using-pthreadbarrier-on-mac-os-x
Note, due to linker errors on duplicate symbols, the functions are made 'inline'
